    ...
    extends Agent
{
                                            ...
                                            HistoryView history)
    {
        ...
        System.out.println("initial step started");
        ...
        List<Integer> resources = state.getAllResourceIds();
        Integer goldResourceNodeId = resources.get(0);
